...
const layers = [
  {
    name: "Macro Layer",
    description: "Unified ledger that reconciles state from all connectors.",
...
export default function ConvergenceLedger() {
  return (
    <PageScaffold
      title="Convergence Ledger"
      subtitle="Unified ledger that reconciles state from all connectors."
      layers={layers}
    />
  );
}
