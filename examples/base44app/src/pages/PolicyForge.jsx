...
const layers = [
  {
    name: "Macro Layer",
    description: "Generate policy bundles using AI-assisted templates and simulations.",
...
export default function PolicyForge() {
  return (
    <PageScaffold
      title="Policy Forge"
      subtitle="Generate policy bundles using AI-assisted templates and simulations."
      layers={layers}
    />
  );
}
