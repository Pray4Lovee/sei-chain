...
const layers = [
  {
    name: "Macro Layer",
    description: "Executive command center for macro and micro operational posture.",
...
export default function SovereignOpsCitadel() {
  return (
    <PageScaffold
      title="Sovereign Ops Citadel"
      subtitle="Executive command center for macro and micro operational posture."
      layers={layers}
    />
  );
}
