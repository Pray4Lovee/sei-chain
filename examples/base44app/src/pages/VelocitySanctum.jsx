...
const layers = [
  {
    name: "Macro Layer",
    description: "Performance sanctum for latency tuning and throughput hardening.",
...
export default function VelocitySanctum() {
  return (
    <PageScaffold
      title="Velocity Sanctum"
      subtitle="Performance sanctum for latency tuning and throughput hardening."
      layers={layers}
    />
  );
}
