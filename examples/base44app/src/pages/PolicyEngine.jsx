...
const layers = [
  {
    name: "Macro Layer",
    description: "Author and enforce governance, risk, and compliance policies in real time.",
...
export default function PolicyEngine() {
  return (
    <PageScaffold
      title="Policy Engine"
      subtitle="Author and enforce governance, risk, and compliance policies in real time."
      layers={layers}
    />
  );
}
